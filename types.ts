...
export type EmailType = 'application_received' | 'application_approved' | 'application_rejected' | 'dues_reminder_30' | 'dues_reminder_7' | 'dues_reminder_0' | 'dues_delinquent' | 'portal_account_setup';
